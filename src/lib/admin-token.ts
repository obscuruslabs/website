// Stateless magic-link tokens for /admin login. HMAC-SHA256 over
// `{ email, exp }`, 30-minute default TTL. Web Crypto only so this is
// edge-runtime compatible — middleware imports this transitively.
//
// Distinct secret from the waitlist token: a leak of one shouldn't let
